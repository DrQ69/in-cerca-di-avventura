...
# 1. What In Cerca di Avventura is

## 1.1 Writer vision — the place

In Cerca di Avventura is not conceived as a conventional portal, dashboard, calendar or database with fantasy decoration applied on top.

It is a **place to enter and traverse**: a persistent fantasy space that gives form to the real Italian Sorcery: Contested Realm community and to the traces it leaves over time.
...
Recurring material vocabulary:

- burnished / blackened iron;
- aged antique gold;
...
The diegetic layer may provide:
